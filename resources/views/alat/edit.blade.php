...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <div>
            <h1>Edit Alat</h1>
            <p>Perbarui informasi alat kesehatan</p>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-header">
            <h2><i class="fas fa-edit mr-3"></i> Edit Alat Kesehatan</h2>
            <p>Update data alat yang sudah ada</p>
        </div>
        ...
        <div class="form-body">
            ...
            <form action="{{ route('admin.alat.update', $alat->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="preview">
                    ...
                    @if($alat->gambar)
                        <img src="{{ asset('storage/' . $alat->gambar) }}" alt="Preview">
                    @else
                ...
                <div class="btn-group">
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fa-solid fa-save"></i> Update Alat
                    </button>
                </div>
            </form>
