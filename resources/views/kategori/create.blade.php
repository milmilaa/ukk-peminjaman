...
@section('title', 'Tambah Kategori - ALMED')
...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p>Tambahkan kategori alat kesehatan ke dalam sistem ALMED</p>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-header">
            <h2><i class="fas fa-tags mr-3"></i> Tambah Kategori</h2>
            <p>Isi nama kategori dengan benar</p>
        </div>
            ...
            <form action="{{ route('admin.kategori.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('nama') }}"
                        class="form-control"
                        placeholder="Contoh: Alat Pernapasan, Tempat Tidur, dll"
                        required>
                </div>
